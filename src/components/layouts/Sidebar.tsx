...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, toggleSidebar }) => {
  ...
  const transactionNavItems = navItems.slice(3, 9);
  const analyticsNavItems = navItems.slice(9, 15);
  const accountNavItems = navItems.slice(15);
    ...
    <div className="flex flex-col h-full">
      <div className="flex h-16 items-center justify-between px-4">
        <Link to="/dashboard" className="flex items-center space-x-2">
          ...
          <span className="text-xl font-bold text-sidebar-foreground">BudgetIQ</span>
        </Link>
        <Button 
          variant="ghost" 
          size="icon" 
